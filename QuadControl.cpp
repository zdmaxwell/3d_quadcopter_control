...
V3F QuadControl::RollPitchControl(V3F accelCmd, Quaternion<float> attitude, float collThrustCmd)
{
  ...
  //  - collThrustCmd is a force in Newtons! You'll likely want to convert it to acceleration first
    ...
    // get R13 and R23 to get the actual body frame orientation relative to intertial frame in x and y directions
    ...
    // calculate b_x_cmd and b_y_cmd, i.e. commanded orientation of quad (use the relationship x_dot_dot = Cc *  b_x_cmd and y_dot_dot = Cc * b_y_cmd)
    // constrain the orientation to safe tilt angle ranges
    ...
    // solve for rate of change of R13 and R23, b_dot_x and b_dot_y (desired rates of change of the tilt angles along the x and y axes)
